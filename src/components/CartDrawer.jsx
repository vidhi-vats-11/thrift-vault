...
export default function CartDrawer() {
  const { lines, isCartOpen, setCartOpen, removeFromCart, updateQty, subtotal, clearCart, pushToast } =
    useCart()

  function handleCheckout() {
    pushToast("Order placed! Thanks for thrifting sustainably 🌱", "success")
    clearCart()
    setCartOpen(false)
  }
