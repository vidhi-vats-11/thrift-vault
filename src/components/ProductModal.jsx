...
import { X, Heart, Minus, Plus, ShoppingBag, Star, Leaf } from "lucide-react"
      ...
      <div className="relative flex max-h-[90vh] w-full max-w-3xl flex-col overflow-y-auto rounded-2xl border border-line bg-surface sm:flex-row">
        ...
        <div className="flex flex-1 flex-col p-6">
          ...
          <p className="mt-4 text-sm leading-relaxed text-white/60">
            Condition: <span className="text-white/80">{product.condition}</span>. Thrifted, inspected and
            steamed by our team — no two pieces are alike, so once it's gone, it's gone for good.
          </p>
